...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('galleries_galleryitem', 'photo_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['photos.Photo']))


    def backwards(self, orm):
        # Changing field 'GalleryItem.photo'
        db.alter_column('galleries_galleryitem', 'photo_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['photos.Photo'], null=True))
