...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GalleryItem.title'
        db.add_column('galleries_galleryitem', 'title', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GalleryItem.title'
        db.delete_column('galleries_galleryitem', 'title')
    ...
    models = {
        ...
        'ella_galleries.galleryitem': {
            ...
            'photo': ('ella.core.cache.fields.CachedForeignKey', [], {'to': "orm['photos.Photo']"}),
            'text': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
