...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'GalleryItem', fields ['gallery', 'order']
        db.delete_unique('ella_galleries_galleryitem', ['gallery_id', 'order'])

        # Changing field 'GalleryItem.photo'
        db.alter_column('ella_galleries_galleryitem', 'photo_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['photos.Photo']))


    def backwards(self, orm):
        
        # Changing field 'GalleryItem.photo'
        db.alter_column('ella_galleries_galleryitem', 'photo_id', self.gf('ella.core.cache.fields.CachedForeignKey')(to=orm['photos.Photo']))

        # Adding unique constraint on 'GalleryItem', fields ['gallery', 'order']
        db.create_unique('ella_galleries_galleryitem', ['gallery_id', 'order'])
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 29, 23, 26, 9, 681553)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 29, 23, 26, 9, 681468)'}),
