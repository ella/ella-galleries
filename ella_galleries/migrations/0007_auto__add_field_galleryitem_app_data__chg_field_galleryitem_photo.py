...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GalleryItem.app_data'
        db.add_column('ella_galleries_galleryitem', 'app_data',
                      self.gf('app_data.fields.AppDataField')(default='{}'),
                      keep_default=False)


        # Changing field 'GalleryItem.photo'
        db.alter_column('ella_galleries_galleryitem', 'photo_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['photos.Photo'], null=True))

    def backwards(self, orm):
        # Deleting field 'GalleryItem.app_data'
        db.delete_column('ella_galleries_galleryitem', 'app_data')


        # Changing field 'GalleryItem.photo'
        db.alter_column('ella_galleries_galleryitem', 'photo_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['photos.Photo']))
